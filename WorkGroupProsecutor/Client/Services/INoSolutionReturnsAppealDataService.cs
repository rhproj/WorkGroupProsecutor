...
{
    public interface INoSolutionReturnsAppealDataService
    {
        ...
        Task<IEnumerable<string>> GetNoSolutionReturnsAppealsByDistrictsForDepartment(string department, string period, int year);
